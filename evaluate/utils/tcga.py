...
base_path = 'D:/Data/TCGA/'

data_dir = base_path + 'EB++AdjustPANCAN_IlluminaHiSeq_RNASeqV2.geneExp.xena.gz'
os_dir = base_path + 'Survival_SupplementalTable_S1_20171025_xena_sp.txt'
type_dir = base_path + 'TCGASubtype.20170308.tsv.gz'
...
add_clinical = pd.read_table(base_path + 'NSCLC/combined_study_clinical_data.tsv', index_col='Patient ID')
